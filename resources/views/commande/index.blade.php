    ...
    <div class="row align-items-end justify-content-between pb-5 g-3">
      ...
      <div class="col-12 col-md-auto">
        <div class="row g-2 gy-3">
          ...
          <div class="col-auto">
            <a href="{{route('commande.create')}}" class="btn btn-sm btn-phoenix-primary bg-white hover-bg-100 me-2">ADD Commande</a>
      ...
      <table class="table fs--1 mb-0 border-top border-200">
        <thead>
          <tr>
            ...
            <th class="sort white-space-nowrap align-middle" scope="col" style="min-width:50px;" data-sort="product">num</th>
            <th class="sort white-space-nowrap align-middle" scope="col" style="min-width:50px;" data-sort="product">date</th>
            <th class="sort align-middle" scope="col" data-sort="customer" style="min-width:100px;">adresse_livraison</th>
            <th class="sort align-middle"  style="min-width:1px;"></th>
          </tr>
        </thead>
        <tbody class="list" id="table-latest-review-body">
            @forelse ($commandes as $category)
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap"><a class="fw-semi-bold" href="apps/e-commerce/landing/product-details.html">{{$category->num}}</a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-900" href="apps/e-commerce/landing/profile.html">
                        ...
                        <h6 class="mb-0 ms-3 text-900">{{$category->date}}</h6>
                    </a>
                    </td>
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-900" href="apps/e-commerce/landing/profile.html">
                      <div class="avatar avatar-l">
                      <h6 class="mb-0 ms-3 text-900">{{ $category->adresse_livraison}}</h6>
                    </a>
                    </td>
                    <td class="align-middle white-space-nowrap text-end pe-0">
                    <div class="position-relative">
                        <div class="hover-actions">
                        <a class="btn btn-phoenix-secondary btn-icon me-1 fs--2 text-900 px-0 me-1" href="{{route('commande.edit',$category->_id)}}"  >
                            <span class="fas fa-edit"></span>
                        </a>
                        <form action="{{route('commande.destroy',$category->_id)}}" method="post">
                            @csrf
            ...
            @empty 
                <tr class="text-center">
                    <td colspan="7">No Commande defined...</td>
                </tr>     
            @endforelse
        </tbody>
      </table>
